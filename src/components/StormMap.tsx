  ...
  useEffect(() => {
    ...
    if (home) {
      L.circleMarker([home.lat, home.lng], {
        ...
        .bindPopup("<strong>Home base</strong>")
        .addTo(map);
    }
      ...
      try {
        ...
        if (res.ok) {
          ...
          for (const f of data?.features || []) {
            ...
            const detail = `<div style="min-width:200px;font-family:system-ui;line-height:1.4">
            ...
            if (
              ...
              hasDrawableGeometry(f.geometry) &&
  ...
  useEffect(() => {
    ...
    const t = window.setTimeout(() => {
      ...
      if (chaseMode) {
        ...
        map.setView([39.5, -98.0], 4, { animate: true });
      }
    }, 220);
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: mapHeight, minHeight: mapHeight }}>
      ...
      >
        ...
        {chaseMode && (
          <div style={{ fontSize: 9, opacity: 0.85, marginTop: 2 }}>CHASE MODE</div>
        )}
      </div>
